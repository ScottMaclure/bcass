...
(function($, window, document, undefined) {
    ...
    Foundation.libs.topbar = {
        ...
        events: function() {
            ...
            $(this.scope).on("click.fndtn.topbar", ".top-bar .toggle-topbar", function(e) {
                var topbar = $(this).closest(".top-bar"), section = topbar.find("section, .section"), titlebar = topbar.children("ul").first();
                if (!topbar.data("height")) self.largestUL();
                e.preventDefault();
                if (self.breakpoint()) {
                    topbar.toggleClass("expanded").css("min-height", "");
                }
                ...
                var topbar = $(this).closest(".top-bar"), section = topbar.find("section, .section"), titlebar = topbar.children("ul").first(), dropdownHeight = $(this).next(".dropdown").outerHeight();
                ...
                if (self.breakpoint()) {
                    ...
                    $this.siblings("ul").height(topbar.data("height") + self.outerHeight(titlebar, true));
                    topbar.css("min-height", topbar.data("height") + self.outerHeight(titlebar, true) * 2);
                }
            });
            $(window).on("resize.fndtn.topbar", function() {
                if (!self.breakpoint()) {
                    $(".top-bar").css("min-height", "").removeClass("expanded");
                }
            }.bind(this));
            // Go up a level on Click
            $(this.scope).on("click.fndtn", ".top-bar .has-dropdown .back", function(e) {
                e.preventDefault();
                var $this = $(this), topbar = $this.closest(".top-bar"), section = topbar.find("section, .section"), $movedLi = $this.closest("li.moved"), $previousLevelUl = $movedLi.parent();
                topbar.data("index", topbar.data("index") - 1);
                if (!self.rtl) {
                    section.css({
                        left: -(100 * topbar.data("index")) + "%"
        ...
        largestUL: function() {
            var uls = this.settings.$topbar.find("section ul ul"), largest = uls.first(), total = 0, self = this;
            uls.each(function() {
...
(function($, window, document, undefined) {
    ...
    Foundation.libs.clearing = {
        ...
        assemble: function($li) {
            ...
            var holder = $("#foundationClearingHolder"), settings = this.get_data($el), grid = $el.detach(), data = {
...
(function($, window, document, undefined) {
    ...
    Foundation.libs.orbit = {
        ...
        _bullets_container_html: function($slides) {
            var self = this, $list = $('<ol class="' + self.settings.bullets_container_class + '"></ol>');
        ...
        _slide_number_html: function(slide_number, total_slides) {
            var self = this, $container = $('<div class="' + self.settings.slide_number_class + '"></div>');
        ...
        _timer_html: function() {
            ...
            if (typeof self.settings.timer_speed === "number" && self.settings.timer_speed > 0) {
                return '<div class="' + self.settings.timer_container_class + '"><span></span><div class="' + self.settings.timer_progress_class + '"></div></div>';
            } else {
                return "";
            }
        },
        ...
        _init: function(idx, slider) {
            var self = this, $slides_container = $(slider), $container = $slides_container.wrap(self._container_html()).parent(), $slides = $slides_container.children();
        ...
        _init_events: function($slides_container) {
            var self = this, $container = $slides_container.parent();
            $(window).on("load.fndtn.orbit", function() {
            ...
            $(document).on("click.fndtn.orbit", "[data-orbit-link]", function(e) {
                e.preventDefault();
                var id = $(e.currentTarget).attr("data-orbit-link"), $slide = $slides_container.find("[data-orbit-slide=" + id + "]").first();
                if ($slide.length === 1) {
                    self._reset_timer($slides_container, true);
                    self._goto($slides_container, $slide.index(), function() {});
                }
            });
            $container.siblings("." + self.settings.bullets_container_class).on("click.fndtn.orbit", "[data-orbit-slide-number]", function(e) {
                e.preventDefault();
                self._reset_timer($slides_container, true);
                self._goto($slides_container, $(e.currentTarget).data("orbit-slide-number"), function() {});
            });
            $container.on("orbit:after-slide-change.fndtn.orbit", function(e, orbit) {
                ...
                e.preventDefault();
                var $timer = $(e.currentTarget).toggleClass(self.settings.timer_paused_class), $slides_container = $timer.closest("." + self.settings.container_class).find("." + self.settings.slides_container_class);
        ...
        _init_dimensions: function($slides_container) {
            var $container = $slides_container.parent(), $slides = $slides_container.children();
        ...
        _start_timer: function($slides_container) {
            ...
            var $timer = $container.find("." + self.settings.timer_container_class), $progress = $timer.find("." + self.settings.timer_progress_class), progress_pct = $progress.width() / $timer.width(), delay = self.settings.timer_speed - progress_pct * self.settings.timer_speed;
            $progress.animate({
                width: "100%"
        ...
        _stop_timer: function($slides_container) {
            var self = this, $container = $slides_container.parent(), $timer = $container.find("." + self.settings.timer_container_class), $progress = $timer.find("." + self.settings.timer_progress_class), progress_pct = $progress.width() / $timer.width();
        ...
        _rebuild_timer: function($container, width_pct) {
            ...
            var self = this, $timer = $container.find("." + self.settings.timer_container_class), $new_timer = $(self._timer_html()), $new_timer_progress = $new_timer.find("." + self.settings.timer_progress_class);
            if (typeof Zepto === "function") {
                $timer.remove();
        ...
        _goto: function($slides_container, index_or_direction, callback) {
            var self = this, $container = $slides_container.parent(), $slides = $slides_container.children(), $active_slide = $slides_container.find("." + self.settings.active_slide_class), active_index = $active_slide.index(), margin_position = Foundation.rtl ? "marginRight" : "marginLeft";
            ...
            if ($slides_container.css(margin_position) === new_margin_left) {
                ...
                $slides_container.trigger("orbit:after-slide-change", [ {
                    slide_number: active_index,
                    total_slides: $slides_container.children().length - 2
                } ]);
                callback();
            } else {
                var properties = {};
...
(function($, window, document, undefined) {
    ...
    Foundation.libs.joyride = {
        ...
        expose: function() {
            var expose, exposeCover, el, origCSS, randId = "expose-" + Math.floor(Math.random() * 1e4);
        ...
        un_expose: function() {
            var exposeId, el, expose, origCSS, clearAll = false;
            if (arguments.length > 0 && arguments[0] instanceof $) {
                el = arguments[0];
            } else if (this.settings.$target && !/body/i.test(this.settings.$target.selector)) {
                el = this.settings.$target;
        ...
        corners: function(el) {
            ...
            tipOffset = Math.ceil(this.settings.$target.offset().top - window_half + this.settings.$next_tip.outerHeight()), right = w.width() + this.scrollLeft(w), offsetBottom = w.height() + tipOffset, bottom = w.height() + w.scrollTop(), top = w.scrollTop();
            if (tipOffset < top) {
                if (tipOffset < 0) {
                    top = 0;
                } else {
        ...
        startTimer: function() {
            ...
            if (this.settings.cookieMonster) {
                $.cookie(this.settings.cookieName, "ridden", {
...
(function($, window, document, undefined) {
    ...
    Foundation.libs.reveal = {
        ...
        close: function(modal) {
            var modal = modal || $(this.scope), open_modals = $(".reveal-modal.open");
    ...
    Foundation.libs.forms = {
        ...
        events: function() {
            ...
            $(window).on("keydown", function(e) {
                var focus = document.activeElement, self = Foundation.libs.forms, dropdown = $(".custom.dropdown.open");
        ...
        refresh_custom_select: function($select, force_refresh) {
            var self = this;
            var maxWidth = 0, $customSelect = $select.next(), $options = $select.find("option"), $listItems = $customSelect.find("li");
    ...
    Foundation.libs.section = {
        ...
        events: function() {
            ...
            $(this.scope).on("click.fndtn.section", "[data-section] .title, [data-section] [data-section-title]", function(e) {
                var $this = $(this), section = $this.closest(self.settings.section_selector);
            ...
            $(document).on("click.fndtn.section", function(e) {
                if ($(e.target).closest(self.settings.title_selector).length < 1) {
                    $(self.settings.nav_selector).children(self.settings.region_selector).removeClass("active").attr("style", "");
                }
            });
        },
        toggle_active: function(e, self) {
            var $this = $(this), self = Foundation.libs.section, region = $this.closest(self.settings.region_selector), content = $this.siblings(self.settings.content_selector), parent = region.parent(), settings = $.extend({}, self.settings, self.data_options(parent)), prev_active_section = parent.children(self.settings.active_region_selector);
            ...
            if (region.hasClass("active")) {
                ...
                if (self.small(parent) || self.is_vertical_nav(parent) || self.is_horizontal_nav(parent) || self.is_accordion(parent)) {
                    if (prev_active_section[0] !== region[0] || prev_active_section[0] === region[0] && !settings.one_up) {
                        region.removeClass("active").attr("style", "");
                    }
                }
            } else {
                var prev_active_section = parent.children(self.settings.active_region_selector), title_height = self.outerHeight(region.children(self.settings.title_selector));
                ...
                if (self.is_vertical_tabs(parent)) {
                    ...
                    if (prev_active_section !== null) {
                        prev_active_section.children(self.settings.content_selector).css("display", "none");
                    }
                }
            }
            setTimeout(function() {
        ...
        resize: function() {
            var self = Foundation.libs.section, sections = $(self.settings.section_selector);
            sections.each(function() {
                var $this = $(this), active_section = $this.children(self.settings.active_region_selector), settings = $.extend({}, self.settings, self.data_options($this));
                if (active_section.length > 1) {
                    active_section.not(":first").removeClass("active").attr("style", "");
                    ...
                    if (self.small($this)) {
                        ...
                        first.css("padding-top", self.outerHeight(first.children(self.settings.title_selector)));
                    }
                }
                if (self.small($this)) {
                    active_section.attr("style", "");
                } else {
                    active_section.css("padding-top", self.outerHeight(active_section.children(self.settings.title_selector)));
                }
                self.position_titles($this);
                if (self.is_horizontal_nav($this) && !self.small($this) || self.is_vertical_tabs($this)) {
        ...
        set_active_from_hash: function() {
            var hash = window.location.hash.substring(1), sections = $("[data-section]"), self = this;
            sections.each(function() {
                var section = $(this), settings = $.extend({}, self.settings, self.data_options(section));
                if (hash.length > 0 && settings.deep_linking) {
                    var regions = section.children(self.settings.region_selector).attr("style", "").removeClass("active");
                    regions.map(function() {
        ...
        position_titles: function(section, off) {
            var self = this, titles = section.children(this.settings.region_selector).map(function() {
                return $(this).children(self.settings.title_selector);
            }), previous_width = 0, previous_height = 0, self = this;
        ...
        position_content: function(section, off) {
            var self = this, regions = section.children(self.settings.region_selector), titles = regions.map(function() {
                return $(this).children(self.settings.title_selector);
            ...
            if (typeof off === "boolean") {
                ...
                if (self.is_vertical_tabs(section) && !self.small(section)) {
                    var content_min_height = 0, content_min_width = Number.MAX_VALUE, title_width = null;
                    regions.each(function() {
                        var region = $(this), title = region.children(self.settings.title_selector), content = region.children(self.settings.content_selector), content_width = 0;
                    ...
                    regions.each(function() {
                        var region = $(this), title = region.children(self.settings.title_selector), content = region.children(self.settings.content_selector);
                        if (!self.rtl) {
                            content.css({
        ...
        position_right: function(el) {
            var self = this, section = el.closest(this.settings.section_selector), regions = section.children(this.settings.region_selector), section_width = el.closest(this.settings.section_selector).width(), offset = regions.map(function() {
                return $(this).children(self.settings.title_selector);
            }).length;
